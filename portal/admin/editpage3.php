...
if(isset($_POST['submitrules'])) {
        $rules = post('rules');
        update_content_rules($rules);
    }
        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">Edit - FAQs</h3>
                </header>
                                    ...
                                    <form method="POST">
                                        <div class="adjoined-bottom">
                                            <div class="grid-container">
                                                ...
                                                <?php $i=1; foreach(get_all_editpage_rules() as $row) { ?>
                                                <textarea id="editor" name="rules"><?php echo $row['content'] ?></textarea>
                                               <?php } ?>
                                                   <input type="submit" name="submitrules" class="btn" style="margin-top: 10px;float: right;">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
