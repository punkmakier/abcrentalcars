...
if(isset($_POST['submitcontactus'])) {
        $contactus = post('contactus');
        update_content_contactus($contactus);
    }
                    ...
                    <ul class="site-menu" data-plugin="menu">
                        ...
                        <li class="dropdown site-menu-item active">
                            <a data-toggle="dropdown" href="editpage.php">
                                <span class="site-menu-title">Edit</span>
                            </a>
                        </li>
        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">Edit - Contact Us</h3>
                </header>
                                    ...
                                    <form method="POST">
                                        <div class="adjoined-bottom">
                                            <div class="grid-container">
                                                ...
                                                <textarea id="editor" name="contactus"><?php echo $row['content'] ?></textarea>
                                               <?php } ?>
                                                   <input type="submit" name="submitcontactus" class="btn" style="margin-top: 10px;float: right;">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
