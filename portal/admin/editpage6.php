...
if(isset($_POST['submittermsandconditions'])) {
        ...
        update_content_termsandconditionsmicro($termsandconditions);
    }
        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">Edit - Micro Terms & Conditions</h3>
                </header>
                                    ...
                                    <form method="POST">
                                        <div class="adjoined-bottom">
                                            <div class="grid-container">
                                                ...
                                                <?php $i=1; foreach(get_all_editpage_termsandconditionsmicro() as $row) { ?>
