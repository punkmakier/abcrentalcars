...
if(isset($_POST['submittermsandconditions'])) {
        ...
        update_content_termsandconditionscustomer($termsandconditions);
    }
        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">Edit - Customer Terms & Conditions</h3>
                </header>
                                    ...
                                    <form method="POST">
                                        <div class="adjoined-bottom">
                                            <div class="grid-container">
                                                ...
                                                <?php $i=1; foreach(get_all_editpage_termsandconditionscustomer() as $row) { ?>
