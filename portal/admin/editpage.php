                                    ...
                                    <form method="POST">
                                        <div class="adjoined-bottom">
                                            <div class="grid-container">
                                                ...
                                                <?php $i=1; foreach(get_all_editpage_aboutus() as $row) { ?>
                                                <textarea id="editor" name="aboutus"><?php echo $row['content'] ?></textarea>
                                               <?php } ?>
                                                   <input type="submit" name="submitaboutus" class="btn" style="margin-top: 10px;float: right;">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
