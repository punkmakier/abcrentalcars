...
if(isset($_POST['btnCreate'])) {
    ...
    save_cars($manufacturer,$no_of_doors,$fuel_tank_capacity,$seating_capacity,$transmission_type,$gear_box,$model,$color,$year,$rate,$fuel_type,$rulesandregulations);
}
    ...
    <div class="page">
        <div class="page-content">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-12 text-right">
                                <button class="btn btn-primary btn-sm" name="btnCreate" type="submit">Create</button>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <a href="my-vehicles.php?action=add" class="btn btn-primary btn-sm">Add Vehicle</a>
                    </div>
                </div>
            </div>
            <div class="panel">
