...
<?php 
    ...
    if(@$_GET['action'] == 'approve') {
        update_transaction_status($_GET['id'],'Approved');
    }
?>
<!DOCTYPE html>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-12 text-right">
                                    ...
                                    <?php } else { ?>
                                        <a href="reservation-details.php?id=<?=$_GET['id']?>&action=approve" onclick="return confirm('Are you sure you want to approve this reservation?')" class="btn btn-success btn-sm">Approve</a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
