...
<?php 
    ...
    if(isset($_POST['saveChanges'])) {
        ...
        update_profile($license,$surname,$firstname,$middlename,$email,$contact);
    }
     if(isset($_POST['btnChangePassword'])) {
        $old_password         = post('old_password');
        $new_password         = post('new_password');
        $confirm_new_password = post('confirm_new_password');
        update_profile_password($old_password,$new_password,$confirm_new_password);
    }
        ...
        <div class="page-content">
            <div class="row">
                <?php if(isset($_GET['success'])) { ?>
                    <div class="col-12">
                        <div class="alert alert-<?=$_GET['success'] == 'false' ? 'danger' : 'info'?>"><?=urldecode($_GET['message'])?></div>
                    </div>
                <?php } ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <form enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" name="upload" class="btn btn-primary btn-block btn-sm">Upload Driver's License</button>
                                        </div>
                                    </form>
                                </div>
